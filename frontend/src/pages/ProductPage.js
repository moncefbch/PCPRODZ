  ...
  return (
    <div>
      <div className="flex-container" style={{ margin: "5%" }}>
        ...
        >
          <header className="font-cabin font-40 mrgn-30">
            {" "}
            HP LAPTOP 15 I3{" "}
          </header>
          <hr
        ...
        <div
          ...
          style={{ height: "600px" }}
        >
          <header className="font-cabin font-40 mrgn-25 font-bold mrgnbtm-0">
            150000 DA
          </header>
          <h5 className="font-cabin font-bold mrgn-30 mrgntp-0">
            Produit neuf
          </h5>
